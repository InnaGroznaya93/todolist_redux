    ...
    const formik = useFormik({
        ...
        validate: (values) => {
            ...
            if(!values.password) {
                ...
                errors.password = 'Password should be longer than 3 symbols'
            }
            return errors
        },
        onSubmit: values => {
            ...
            <form onSubmit={formik.handleSubmit}>
                <FormControl>
                    ...
                    <FormGroup>
                        ...
                        <FormControlLabel label={'Remember me'} control={<Checkbox onChange={formik.handleChange} checked={formik.values.rememberMe} name={'rememberMe'}/>}/>
